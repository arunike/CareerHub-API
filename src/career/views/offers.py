    ...
    def transition_advisor(self, request):
        ...
        for o in offers:
            ...
            serialized_real_offers.append({
                ...
                "sick_leave_days": o.sick_leave_days,
                "sick_leave_included_in_unlimited_pto": o.sick_leave_included_in_unlimited_pto,
        ...
        for o in simulated_offers:
            ...
            serialized_simulated_offers.append({
                ...
                "sick_leave_days": int(o.get('sick_leave_days') or 0),
                "sick_leave_included_in_unlimited_pto": o.get(
