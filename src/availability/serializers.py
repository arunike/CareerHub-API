...
class CustomHolidaySerializer(serializers.ModelSerializer):
    class Meta:
        model = CustomHoliday
        fields = ['id', 'date', 'group_id', 'description', 'holiday_type', 'is_recurring', 'is_locked', 'tab', 'pto_experience_ids', 'counts_as_pto']
...
class UserSettingsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'default_mpg', 'default_gas_price_per_gallon',
            'ignored_federal_holidays', 'employment_types', 'holiday_tabs', 'default_holiday_color', 'federal_holiday_color', 'application_stages', 'hidden_nav_items', 'hidden_income_roles', 'hidden_income_years',
